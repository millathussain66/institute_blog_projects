...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2023 at 03:43 PM
...
(1, 'Newest Blog and content management', 'blog,php,bootstrap', '<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</div><div>tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</div><div>quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo</div><div>consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse</div><div>cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non</div><div>proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>', '50388700_1677226400.jpg', 'publish', NULL, NULL, 8),
...
(7, 'ssffdadsfafsdfs', 'kkk', 'sdfsfdsfs<br>', '70830800_1677226807.png', 'publish', '2023-02-24', 'admin', 6),
(8, 'Doloremque dolor voluptatem culpa pariatur In ut sit voluptate eu excepturi', 'computer', '<p class=\"page-header__description m0 f1 cl-white\" itemprop=\"description\"><em>Lorem ipsum</em> is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</p><p class=\"page-header__description m0 f1 cl-white\" itemprop=\"description\"><em>Lorem ipsum</em> is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</p>', '00233800_1677230476.jpg', 'publish', '2023-02-24', 'admin2', 7),
(9, 'Ipsum dignissimos sint eos voluptatum autem in odio quia sunt elit tempor', 'Exercitation aperiam optio nesciunt an', 'Velit, eumsdfsfsfsf ea sapien.', '99400400_1677231046.jpg', 'publish', '2023-02-24', 'admin2', 6),
(10, 'sdfs', 'sdfsf', 'sfsfsfsfs', '64589700_1677432269.jpg', 'draft', '2023-02-26', 'millat', 6),
(11, 'sdfs', 'sdfsf', 'stuffs', '03712600_1677511989.jpg', 'publish', '2023-02-27', 'metaxyh', 7),
(12, 'sdfs', 'sdfs', 'sdfs', '09983900_1677512181.jpg', 'draft', '2023-02-27', 'metaxyh', 5);
...
(6, 'etemesi', 'titles', 1, 3, 3, 3),
(7, 'etemesi', 'links', 1, 3, 3, 3),
(8, 'etemesi', 'blog_categories', 1, 3, 3, 3),
(9, 'etemesi', 'blogs', 1, 3, 3, 3),
(10, 'etemesi', 'editors_choice', 1, 3, 3, 3);
...
(1, 'titles', '1', 'admin', 1524766759, 1677226606, 2),
...
(7, 'blog_categories', '5', 'admin', 1524773974, 1677226443, 2),
(8, 'blogs', '1', 'admin', 1524778647, 1677226468, 2),
...
(14, 'editors_choice', '2', 'admin', 1524799903, 1677226719, 2),
...
(18, 'blog_categories', '7', 'admin', 1677226300, 1677226325, 2),
(19, 'blog_categories', '8', 'admin', 1677226462, 1677226462, 2),
(20, 'blogs', '7', 'admin', 1677226807, 1677226807, 2),
(21, 'blogs', '8', 'admin2', 1677230476, 1677230476, 3),
(22, 'blogs', '9', 'admin2', 1677231046, 1677231386, 3),
(23, 'blog_categories', '9', 'admin', 1677231460, 1677231460, 2),
(24, 'blogs', '10', 'millat', 1677432269, 1677432269, 3),
(25, 'blogs', '11', 'metaxyh', 1677511989, 1677511989, 3),
(26, 'blogs', '12', 'metaxyh', 1677512181, 1677512181, 3);
...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'millathussain127166@gmail.com', '2023-04-12', 2, 0, 1, NULL, NULL, NULL, NULL, 'Admin member created automatically on 2018-04-26\nRecord updated automatically on 2018-04-27\nRecord updated automatically on 2023-02-24\nRecord updated automatically on 2023-02-24\nRecord updated automatically on 2023-02-24', NULL, NULL),
('admin2', 'c84258e9c39059a89ab77d846ddab909', 'jopodi.ifalaf@rungel.net', '2023-02-24', 3, 0, 1, 'MIllat Hussain', 'Dhaka Bangladesh', 'Mymensingh', '0125412574444', 'member signed up through the registration form.\nmember updated his profile on 02/24/2023, 12:32 pm from IP address 127.0.0.1', NULL, NULL),
...
('metaxyh', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 'pimuqa@mailinator.com', '2023-02-27', 3, 0, 1, 'Scarlett Rasmussen', 'Doloribus quisquam n', 'Quam adipisci sequi', '+1 (985) 433-8721', 'member signed up through the registration form.', NULL, NULL),
('millat', '9e7eaf8115b78411aa91e1ede8de2d3a', 'millathussain127166@gmail.com', '2023-02-26', 3, 0, 1, '', '', '', '', 'member signed up through the registration form.', NULL, NULL),
('millathussain', 'f261fc5b32a905f3dde728d2f04a4b7a', 'ronniengoda@gmail.com', '2023-02-24', 2, 0, 1, NULL, NULL, NULL, NULL, 'Admin member created automatically on 2023-02-24', NULL, NULL),
('safozy', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 'jopodi.ifalaf@rungel.net', '2023-02-24', 2, 1, 1, 'Dustin Barton', 'Sint rem ipsa non s', 'Distinctio Et liber', '+1 (503) 298-7209', 'Necessitatibus eum v', NULL, NULL);
...
('Doloremque dolor voluptatem culpa pariatur In ut sit voluptate eu excepturi', 3),
('Ipsum dignissimos sint eos voluptatum autem in odio quia sunt elit tempor', 1),
('Newest Blog and content management', 2),
('ssffdadsfafsdfs', 1),
...
(55, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0', '2023-02-24 08:14:47'),
(56, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0', '2023-02-24 08:20:10'),
(57, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0', '2023-02-24 08:20:15'),
(58, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0', '2023-02-24 09:21:22'),
(59, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0', '2023-02-24 09:36:36'),
(60, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0', '2023-02-24 09:41:47'),
(61, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36', '2023-02-25 09:53:10');
